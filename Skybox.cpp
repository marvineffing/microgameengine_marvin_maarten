...
#include "Mesh.hpp"
#include "Texture.hpp"
Skybox::Skybox(std::string aName, glm::vec3 aPosition, ShaderProgram* shaderProgram )
:	GameObject(aName, aPosition, shaderProgram)
{
	Mesh * planeMesh = Mesh::load("models/plane.obj");
    float test = 50;

    upPlane = new GameObject("PLANE", glm::vec3(-test/2,test/2,-test/2), _shaderProgram);
    ...
    bottomPlane = new GameObject("PLANE", glm::vec3(-test/2,-test/2,test/2), _shaderProgram);
    ...
    frontPlane = new GameObject("PLANE", glm::vec3(-test/2,-test/2,-test/2), _shaderProgram);
    ...
    backPlane = new GameObject("PLANE", glm::vec3(test/2,-test/2,test/2), _shaderProgram);
    ...
    rightPlane = new GameObject("PLANE", glm::vec3(test/2,-test/2,-test/2), _shaderProgram);
    ...
    leftPlane = new GameObject("PLANE", glm::vec3(-test/2,-test/2,test/2), _shaderProgram);
